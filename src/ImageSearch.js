    ...
    <div className="max-w-sm rounded overflow-hidden my-10 mx-auto">
        ...
        <form onSubmit={onSubmit}className="w-full max-w-sm">
            ...
            border-teal-500 py-2">
                <input onChange={e => {setText(e.target.value); console.log(text)}} className="appearance-none bg-transparent border-none
                w-full text-gray-700 mr-3 py-2 leading-tight focus:outline-none"
